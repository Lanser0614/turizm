                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="messages" id="textarea" name="textarea" rows="4" placeholder="Your Messages"></textarea>
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-6 col-12 mb20">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                ...
                                <p>
                                    @foreach ($siteDetail as $item)
                                    <strong>{{$item->phone_number}}<br></strong>
                                    @endforeach
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-6 col-12 mb20 ">
                        <div class="contact-info">
                            ...
                            <div class="contact-info-content">
                                ...
                                <p>@foreach ($siteDetail as $item)
                                    <strong>{{$item->mail}}<br> </strong>
                                    @endforeach
                                </p>
                            </div>
                        </div>
